...
function drawText() {
    ...
    if(frameNumber > 2000 && frameNumber < 2250){
        ...
        if (window.innerWidth < 600) {
            drawTextWithLineBreaks(["Ama ağzımdan çıkanlar yüzünden, En son kaybetmek isteyeceğim insan sensin"], canvas.width / 2, canvas.height / 2, fontSize, lineHeight);
        } else {
            context.fillText("Ama ağzımdan çıkanlar yüzünden, En son kaybetmek isteyeceğim insan sensin", canvas.width/2, canvas.height/2);
        }
